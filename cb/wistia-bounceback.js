/* Bounceback.js v1.0.0 | Copyright 2014 Avi Kohn | Distributable under the MIT license */ ! function(a, b) {
  ...
  c.noConflict = function() {
    ...
    get: function(c) {
      ...
      for (var d = b.cookie.split(";"), e = -1, f = [], g = d.length; ++e < g;)
        if (f = d[e].split("="), f[0] == c) return f.shift(), f.join("=");
      return ""
    },
    set: function(d, e) {
      if (a.localStorage) a.localStorage.setItem(d, e);
      else {
        var f = new Date;
  ...
  return c.onBounce = function() {
    ...
    if ("history" == e) "replaceState" in a.history ? (a.history.replaceState({
      isBouncing: !0
    }, a.title), a.history.pushState(null, a.title), d(a, "popstate", function() {
